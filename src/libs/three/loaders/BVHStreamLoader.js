...
THREE.BVHLoader.prototype = {
	...
	streamData: function(data, root, bones) {
		var tokens = data.split( /[\s]+/ );
        var ret = readFrameData( tokens, i * 0.017, root, bones );
        console.log(ret);
	},
	...
	parse: function ( buffer ) {
		...
		*/
        ...
        function addAnimationTracksForFrame( bones, frameIndex,  tracks) {
		...
		*/
		...
		return {
            ...
            addAnimationTracksForFrame: addAnimationTracksForFrame
		};
