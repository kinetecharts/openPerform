...
class InputManager {
	...
	scaleLimbSequence() {
		this.parent.performers.performers[Object.keys(this.parent.performers.performers)[0]].limbSequence(
			[
				{name: 'head', scale: 2, time: 2000, delay: 20000},
				{name: 'head', scale: 1, time: 2000, delay: 0},
				{name: 'leftshoulder', scale: 2, time: 2000, delay: 20000},
				{name: 'leftshoulder', scale: 1, time: 2000, delay: 0},
				{name: 'rightupleg', scale: 2, time: 2000, delay: 20000},
				{name: 'rightupleg', scale: 1, time: 2000, delay: 0},

				// {name: 'head', scale: 0.75, time: 2000, delay: 0},
				{name: 'leftshoulder', scale: 0.75, time: 2000, delay: 0},
				{name: 'rightshoulder', scale: 0.75, time: 2000, delay: 0},
				{name: 'leftupleg', scale: 0.5, time: 2000, delay: 0},
				{name: 'rightupleg', scale: 0.5, time: 2000, delay: 20000},

				{name: 'leftshoulder', scale: 1, time: 2000, delay: 0},
				{name: 'rightshoulder', scale: 1, time: 2000, delay: 0},
				{name: 'leftupleg', scale: 1, time: 2000, delay: 0},
				{name: 'rightupleg', scale: 1, time: 2000, delay: 0},

				// {name: 'leftshoulder', scale: 2, time: 5000, delay: 0},
				// {name: 'rightshoulder', scale: 0.75, time: 2000, delay: 0},
				// {name: 'leftupleg', scale: 2, time: 5000, delay: 0},
				// {name: 'rightupleg', scale: 0.75, time: 2000, delay: 0}
		]);
	}
