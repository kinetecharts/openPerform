...
class PerformerCameraMenu extends React.Component {
  constructor(props) {
    super(props);
    this.props = props;
    this.state = {
  ...
  render() {
    const popoverTop = (
      <Popover id="performer-camera-popover" title="Follow Performer">
        <ListGroup>
          <ListGroupItem>
              <Table className="performerCameraTable">
                <tbody>
                  <tr>
                    <td title="Follow Performer" onClick={this.props.toggleFollow}>
                      {(this.props.following) ? <Icon name="ban" /> : <Icon name="video-camera" />}
                      <span>Follow</span>
                    </td>
                    <td title="Snorry (Chest Cam)" onClick={this.props.toggleSnorry}>
                      {(this.props.snorry) ? <Icon name="ban" /> : <Icon name="video-camera" />}
                      <span>Snorry</span>
                    </td>
                    <td title="First Person View" onClick={this.props.toggleFirstPerson}>
                      {(this.props.firstPerson) ? <Icon name="ban" /> : <Icon name="video-camera" />}
                      <span>First</span>
                    </td>
                  </tr>
                </tbody>
...
module.exports = PerformerCameraMenu;
