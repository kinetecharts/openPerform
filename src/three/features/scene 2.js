...
import Performer from './displayComponents/Performer'
...
class Scene {
	...
	initScene(startPos, radius, mouseEnabled, statsEnabled) {
		...
		this.controls.enableZoom = mouseEnabled;
		this.controls.enableRotate = mouseEnabled;
		this.controls.enablePan = mouseEnabled;
		...
		this.globe = new Globe(this.scene, 16000);

		this.earth.mesh.position.set(0, 0, 0);
		this.globe.points.position.set(0, 0, 0);
