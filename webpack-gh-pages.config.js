...
module.exports = {
	...
	plugins: [
		new CopyWebpackPlugin([
      {
        ...
        to: resolve(__dirname, './docs/' + config.copy.html.dest),
      },
      {
        from: resolve(__dirname, config.copy.images.src),
        to: resolve(__dirname, './docs/' + config.copy.images.dest),
      },
      {
        from: resolve(__dirname, config.copy.textures.src),
        to: resolve(__dirname, './docs/' + config.copy.textures.dest),
			},
			{
        from: resolve(__dirname, config.copy.models.src),
        to: resolve(__dirname, './docs/' + config.copy.models.dest),
			},
			{
        from: resolve(__dirname, config.copy.animations.src),
        to: resolve(__dirname, './docs/' + config.copy.animations.dest),
			},
			{
        from: resolve(__dirname, config.copy.bmfonts.src),
        to: resolve(__dirname, './docs/' + config.copy.bmfonts.dest),
      },
    ]),
